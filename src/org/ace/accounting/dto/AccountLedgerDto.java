...
//	private TranType tranType;
	...
	// customized to get debit, credit, homeDebit, homeCredit according to
	// TransType's TranCode
	public AccountLedgerDto(String coaId,AccountType acType, BigDecimal debit, BigDecimal credit, BigDecimal homeDebit, BigDecimal homeCredit, String narration, Date settlementDate,
			String currencyId,
			String branchId, TranCode tranCode) {
		super();
		this.coaId= coaId;
	...
	public AccountLedgerDto(String coaId,AccountType acType, BigDecimal debit, BigDecimal credit, String narration, Date settlementDate) {
		super();
		this.coaId= coaId;
		this.acType = acType;
		this.debit = debit;

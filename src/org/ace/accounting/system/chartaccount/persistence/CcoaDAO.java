...
public class CcoaDAO extends BasicDAO implements ICcoaDAO {
	...
	public List<ObalDto> findObal(ObalCriteriaDto dto) throws DAOException {
		...
		try {
			StringBuffer queryString = new StringBuffer();
			queryString
					.append("SELECT NEW org.ace.accounting.dto.ObalDto(c.coa.acCode,c.acName,c.oBal,c.hOBal,c.coa.acType,c.branch,c.department,c.currency,c.id,c.coa.headId,c.coa.groupId) "

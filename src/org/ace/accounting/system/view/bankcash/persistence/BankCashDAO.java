...
public class BankCashDAO extends BasicDAO implements IBankCashDAO {
	...
	public List<BankCashDto> findDailyTransaction(CurrencyType type, Currency currency, Date reportDate, boolean curConverted, Branch branch) {
		...
		try {
			...
			queryString.append(" SELECT v.acode as ACODE,c.acName as ACNAME,v.ACODE AS ACCOUNTCODE, ");
			...
			queryString.append(" FROM VW_BANKCASH v INNER JOIN COA c ON v.ACODE=c.ACCODE ");
			...
			queryString.append(" GROUP BY v.ACODE,c.ACNAME,v.STATUS,v.ACODE ");
			queryString.append(" ) T GROUP BY T.ACODE,T.ACNAME,T.ACCOUNTCODE ORDER BY T.ACCOUNTCODE ");

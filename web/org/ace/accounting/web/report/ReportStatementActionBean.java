...
//							.filter(report -> report.getcBal().doubleValue() != 0.00)
					...
					/* For Left Record */
//					parameters.put("DTOLIST", new JRBeanCollectionDataSource(reportStatementDtoList2.stream().filter(report->null != report.getColType()).filter(report->report.getColType().equals(ColType.L)).filter(report->report.getcBal().doubleValue() != 0.00).collect(Collectors.toList())));
//					/* For Right Record */
//					parameters.put("RightDTOList", new JRBeanCollectionDataSource(reportStatementDtoList2.stream().filter(report->null != report.getColType()).filter(report->report.getColType().equals(ColType.R)).filter(report->report.getcBal().doubleValue() != 0.00).collect(Collectors.toList())));
				} else {
...
//							.collect(Collectors.toList())));
					/* For Right Record */
//					parameters.put("RightDTOList", new JRBeanCollectionDataSource(reportStatementDtoList2.stream()
//							.filter(report -> null != report.getColType())
...
//							.collect(Collectors.toList())));
					/* For Right Record */
//					parameters.put("RightDTOList", new JRBeanCollectionDataSource(dtoList.stream()
//							.filter(report -> null != report.getColType())
//							.filter(report -> report.getColType().equals(ColType.R))
//							.filter(report -> report.getcBal().doubleValue() != 0.00)
//							.collect(Collectors.toList())));
